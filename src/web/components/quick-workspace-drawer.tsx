...
export function QuickWorkspaceDrawer(props: QuickWorkspaceDrawerProps) {
  ...
  return <>
    {props.open ? <button type="button" className="sidebar-scrim" style={{ display: "block", position: "fixed", inset: 0, zIndex: 29 }} aria-label="点击遮罩关闭快捷资源管理" onClick={props.onClose} /> : null}
